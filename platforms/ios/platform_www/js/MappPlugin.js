 ...
 */
MappPlugin.prototype.engage = function (sdkID, googleProjectId, cepURL, appID, tenantID, successCallback, errorCallback) {

    MappPlugin.callMappPlugin(successCallback, errorCallback, 'engage', [sdkID, googleProjectId, cepURL, appID, tenantID]);
}
...
*TODO iOS only
*/
MappPlugin.prototype.enableLocationMonitoringCordova = function(successCallback, errorCallback) {
    MappPlugin.callMappPlugin(successCallback, errorCallback, 'enableLocationMonitoringCordova');
}

MappPlugin.prototype.disableLocationMonitoringCordova = function(successCallback, errorCallback) {
...
*TODO iOS only
*/
MappPlugin.prototype.engage = function(sdkID,  successCallback, errorCallback) {
    MappPlugin.callMappPlugin(successCallback, errorCallback, 'engage', [sdkID]);
}

MappPlugin.prototype.reportInteractionEventWithNameAndAttributes = function(name, attributes, successCallback, errorCallback){
    MappPlugin.callMappPlugin(successCallback, errorCallback, 'reportInteractionEventWithNameAndAttributesCordova', [name,attributes]);
}

MappPlugin.prototype.fireInAppEvent = function(appId,tenantId, userId,deviceId, jamieUrl, alias, eventName, successCallback, errorCallback){
    MappPlugin.callMappPlugin(successCallback, errorCallback, 'fireInappEventWithAppIdTenantIdUserIdDeviceIdJamieUrlAliasAndEventName',[appId, tenantId, userId,deviceId,jamieUrl,alias, eventName]);
}
